...
{
    //nesnesi oluşturulamayan ( new'lenemeyen) sadece miras alınabilen soyut sınıflardır
    abstract class Cihaz
    {
        public string Barkod { get; set; }
        public string BarkodGetir()
        {
            return "Barkod : " + this.Barkod; //içinde bulunduğumuz classın barkod propertysini göndersin.
        }
        //mutlaka publiv erişim belirleyicisi olmak zorundadır
        //mutlaka içinde bulunduğu sınıfabstract olması gerekiyor 
